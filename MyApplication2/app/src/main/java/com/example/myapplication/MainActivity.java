...
/*
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.DialPhone :
                Intent intent1 = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:1777043135"));
            ...
            case R.id.ShowLocation :
                Intent intent2 = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:51.2134624,6.6020345,14"));
                startActivity(intent2);

                break;
            case R.id.OpenWebPage :
                Intent intent3 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://wwww.facebook.com"));
            ...
            case R.id.LetsGetPro :
                //Intent intent5 = new Intent("com.example.myapplication.OtherActivity");
               // startActivity(intent5);
                Intent intent6 = new Intent(Intent.ACTION_VIEW);
                intent6.putExtra("KEY","Value is My Date..");
