...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText InputName, InputPassword, InputPhoneNbr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputPhoneNbr = (EditText)findViewById(R.id.register_phone_number_input);
    ...
    private void CreateAccount() {
        ...
        if (TextUtils.isEmpty(name)){
            ...
            loadingBar.setMessage("Please waite, while we are checking the credentials.");
